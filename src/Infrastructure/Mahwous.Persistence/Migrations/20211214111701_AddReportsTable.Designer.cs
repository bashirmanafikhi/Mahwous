...
namespace Mahwous.Persistence.Migrations
{
    ...
    [Migration("20211214111701_AddReportsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mahwous.Core.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mahwous.Core.Entities.Category", b =>
                {
                    b.HasOne("Mahwous.Persistence.Models.ApplicationUser", "User")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("Mahwous.Core.Entities.Report", b =>
                {
                    ...
                    b.HasOne("Mahwous.Persistence.Models.ApplicationUser", "Violator")
