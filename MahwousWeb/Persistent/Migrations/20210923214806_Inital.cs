        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ForVideos = table.Column<bool>(type: "bit", nullable: false),
                    ForImages = table.Column<bool>(type: "bit", nullable: false),
                    ForQuotes = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppleStoreLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PlayStoreOpenedCount = table.Column<int>(type: "int", nullable: false),
                    AppleStoreOpenedCount = table.Column<int>(type: "int", nullable: false),
                    Visible = table.Column<bool>(type: "bit", nullable: false),
                    ViewsCount = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryStatus", x => new { x.CategoriesId, x.StatusesId });
                    table.ForeignKey(
                        name: "FK_CategoryStatus_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryStatus_Statuses_StatusesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryStatus_StatusesId",
